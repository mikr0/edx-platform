...
To work around this issue, use `ulimit -n` to set the number of allowed open files. Coffee watches
both directories and files, so you will need to set this fairly high (anecdotally, `ulimit -n 8000`
seems to do the trick on OSX 10.7.5, 10.8.3, and 10.8.4)
