...
def save_subs_to_store(subs, subs_id, org, course):
...
def download_youtube_subs(youtube_subs, org, course):
    """Download subtitles from Youtube using `youtube_ids`, and
    save them to assets for location with `org` organization name and
    `course` course name."""
    ...
    for speed, youtube_id in sorted(youtube_subs.iteritems()):
        ...
        save_subs_to_store(subs, youtube_id, org, course)
